...
class GLFW implements GLConsts implements GLProcs {
    ...
    @:GLConst var NOT_INITIALIZED;
    @:GLConst var NO_CURRENT_CONTEXT;
    @:GLConst var INVALID_ENUM;
    @:GLConst var INVALID_VALUE;
    @:GLConst var OUT_OF_MEMORY;
    @:GLConst var API_UNAVAILABLE;
    @:GLConst var VERSION_UNAVAILABLE;
    @:GLConst var PLATFORM_ERROR;
    @:GLConst var FORMAT_UNAVAILABLE;
